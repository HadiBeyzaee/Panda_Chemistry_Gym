...
from panda_chemistry_gym.core import PyBulletRobot
...
class Panda(PyBulletRobot):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            joint_forces=np.array([87.0, 87.0, 87.0, 87.0, 12.0, 120.0, 120.0, 180.0, 180.0]),
        )

        self.fingers_indices = np.array([9, 10])

        self.neutral_joint_values = np.array([0.4, 0.71, 0.0, -1.5, -0.60, 2.26, 0.79, 0.0, 0.0])
        self.ee_link = 11
